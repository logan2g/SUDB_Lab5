...
{
    public partial class PredpriyatieContext : DbContext
    {
        public PredpriyatieContext()
        {
        }

        public PredpriyatieContext(DbContextOptions<PredpriyatieContext> options)
            : base(options)
        {
        }

        public virtual DbSet<AssignmentToPost> AssignmentToPosts { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AssignmentToPost>(entity =>
            {
                ...
                entity.HasOne(d => d.Department)
                    .WithMany(p => p.AssignmentToPosts)
